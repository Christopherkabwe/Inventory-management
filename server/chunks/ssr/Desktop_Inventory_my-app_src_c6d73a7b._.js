...
async function DashboardPage() {
    ...
    /* -----------------------------
       TOP LOW STOCK
    ----------------------------- */ const topLowStock = allProducts.filter(isLowStock).sort((a, b)=>a.quantity - b.quantity).slice(0, 10);
    /* -----------------------------
       AUTO-RESTOCK ALERTS
...
//# sourceMappingURL=Desktop_Inventory_my-app_src_c6d73a7b._.js.map