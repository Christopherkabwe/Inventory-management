module.exports = [
"[project]/Desktop/Inventory/my-app/src/generated/prisma/query_compiler_bg.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/Desktop/Inventory/my-app/src/generated/prisma/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 */ const config = {
    ...
    "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider        = \"prisma-client-js\"\n  output          = \"../src/generated/prisma\"\n  engineType      = \"binary\"\n  previewFeatures = [\"clientExtensions\"] // ← enable JS output mode\n}\n\ndatasource db {\n  provider = \"postgresql\"\n}\n\nmodel ProductList {\n  id          String      @id @default(cuid())\n  sku         String      @unique\n  name        String\n  price       Float\n  packSize    Int\n  category    String?\n  weightValue Float\n  weightUnit  String\n  createdBy   String\n  createdAt   DateTime    @default(now())\n  updatedAt   DateTime    @updatedAt\n  inventories Inventory[]\n  sales       Sale[]\n\n  @@index([sku])\n}\n\nmodel Inventory {\n  id         String      @id @default(cuid())\n  productId  String\n  product    ProductList @relation(fields: [productId], references: [id])\n  locationId String\n  location   Location    @relation(fields: [locationId], references: [id])\n  quantity   Int\n  lowStockAt Int\n  expiryDate DateTime?\n  createdBy  String\n  createdAt  DateTime    @default(now())\n  updatedAt  DateTime    @updatedAt\n\n  stockMovements StockMovement[] // ← add this\n\n  @@unique([productId, locationId])\n  @@index([productId])\n}\n\nmodel Location {\n  id        String   @id @default(cuid())\n  name      String   @unique\n  address   String?\n  createdBy String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  inventories Inventory[]\n  sales       Sale[]\n\n  stockMovementsFrom StockMovement[] @relation(\"StockMovementFromLocation\") // ← add\n  stockMovementsTo   StockMovement[] @relation(\"StockMovementToLocation\") // ← add\n\n  @@index([id])\n}\n\nmodel Sale {\n  id           String      @id @default(cuid())\n  customerId   String\n  customerName String?\n  productId    String\n  productName  String?\n  quantity     Int\n  locationId   String\n  location     Location    @relation(fields: [locationId], references: [id])\n  salePrice    Float\n  totalAmount  Float\n  saleDate     DateTime    @default(now())\n  createdBy    String\n  createdAt    DateTime    @default(now())\n  updatedAt    DateTime    @updatedAt\n  customer     Customer    @relation(fields: [customerId], references: [id])\n  product      ProductList @relation(fields: [productId], references: [id], onDelete: Cascade)\n\n  stockMovements StockMovement[] // ← add\n\n  @@index([customerId])\n  @@index([productId])\n}\n\nmodel Customer {\n  id        String   @id @default(cuid())\n  name      String\n  email     String   @unique\n  phone     String\n  country   String\n  city      String\n  createdBy String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n  sales     Sale[]\n\n  stockMovements StockMovement[] // ← add\n}\n\nmodel StockMovement {\n  id          String    @id @default(cuid())\n  inventoryId String\n  inventory   Inventory @relation(fields: [inventoryId], references: [id])\n\n  type     String // 'RECEIPT', 'SALE', 'TRANSFER_IN', 'TRANSFER_OUT', 'EXPIRED', 'DAMAGED', 'ADJUSTMENT', 'RETURN', 'REBAG_GAIN', 'REBAG_LOSS'\n  quantity Int\n\n  fromLocationId String? // optional, for transfers\n  fromLocation   Location? @relation(\"StockMovementFromLocation\", fields: [fromLocationId], references: [id])\n\n  toLocationId String? // optional, for transfers\n  toLocation   Location? @relation(\"StockMovementToLocation\", fields: [toLocationId], references: [id])\n\n  saleId String? // optional, link to a sale if type is SALE\n  sale   Sale?   @relation(fields: [saleId], references: [id])\n\n  customerId String? // optional, link to a customer for returns, sales\n  customer   Customer? @relation(fields: [customerId], references: [id])\n\n  reason String? // e.g., 'Expired', 'Damaged', 'Stocktake'\n\n  openingStock  Int? // stock at start of day/period\n  physicalStock Int? // stock counted during stocktake\n  closingStock  Int? // stock after movement and adjustments\n\n  createdAt DateTime @default(now())\n  createdBy String\n}\n"
};
config.runtimeDataModel = JSON.parse("{\"models\":{\"ProductList\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"sku\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"name\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"price\",\"kind\":\"scalar\",\"type\":\"Float\"},{\"name\":\"packSize\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"category\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"weightValue\",\"kind\":\"scalar\",\"type\":\"Float\"},{\"name\":\"weightUnit\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdBy\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"updatedAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"inventories\",\"kind\":\"object\",\"type\":\"Inventory\",\"relationName\":\"InventoryToProductList\"},{\"name\":\"sales\",\"kind\":\"object\",\"type\":\"Sale\",\"relationName\":\"ProductListToSale\"}],\"dbName\":null},\"Inventory\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"productId\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"product\",\"kind\":\"object\",\"type\":\"ProductList\",\"relationName\":\"InventoryToProductList\"},{\"name\":\"locationId\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"location\",\"kind\":\"object\",\"type\":\"Location\",\"relationName\":\"InventoryToLocation\"},{\"name\":\"quantity\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"lowStockAt\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"expiryDate\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"createdBy\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"updatedAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"stockMovements\",\"kind\":\"object\",\"type\":\"StockMovement\",\"relationName\":\"InventoryToStockMovement\"}],\"dbName\":null},\"Location\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"name\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"address\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdBy\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"updatedAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"inventories\",\"kind\":\"object\",\"type\":\"Inventory\",\"relationName\":\"InventoryToLocation\"},{\"name\":\"sales\",\"kind\":\"object\",\"type\":\"Sale\",\"relationName\":\"LocationToSale\"},{\"name\":\"stockMovementsFrom\",\"kind\":\"object\",\"type\":\"StockMovement\",\"relationName\":\"StockMovementFromLocation\"},{\"name\":\"stockMovementsTo\",\"kind\":\"object\",\"type\":\"StockMovement\",\"relationName\":\"StockMovementToLocation\"}],\"dbName\":null},\"Sale\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"customerId\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"customerName\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"productId\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"productName\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"quantity\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"locationId\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"location\",\"kind\":\"object\",\"type\":\"Location\",\"relationName\":\"LocationToSale\"},{\"name\":\"salePrice\",\"kind\":\"scalar\",\"type\":\"Float\"},{\"name\":\"totalAmount\",\"kind\":\"scalar\",\"type\":\"Float\"},{\"name\":\"saleDate\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"createdBy\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"updatedAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"customer\",\"kind\":\"object\",\"type\":\"Customer\",\"relationName\":\"CustomerToSale\"},{\"name\":\"product\",\"kind\":\"object\",\"type\":\"ProductList\",\"relationName\":\"ProductListToSale\"},{\"name\":\"stockMovements\",\"kind\":\"object\",\"type\":\"StockMovement\",\"relationName\":\"SaleToStockMovement\"}],\"dbName\":null},\"Customer\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"name\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"email\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"phone\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"country\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"city\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdBy\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"updatedAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"sales\",\"kind\":\"object\",\"type\":\"Sale\",\"relationName\":\"CustomerToSale\"},{\"name\":\"stockMovements\",\"kind\":\"object\",\"type\":\"StockMovement\",\"relationName\":\"CustomerToStockMovement\"}],\"dbName\":null},\"StockMovement\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"inventoryId\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"inventory\",\"kind\":\"object\",\"type\":\"Inventory\",\"relationName\":\"InventoryToStockMovement\"},{\"name\":\"type\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"quantity\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"fromLocationId\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"fromLocation\",\"kind\":\"object\",\"type\":\"Location\",\"relationName\":\"StockMovementFromLocation\"},{\"name\":\"toLocationId\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"toLocation\",\"kind\":\"object\",\"type\":\"Location\",\"relationName\":\"StockMovementToLocation\"},{\"name\":\"saleId\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"sale\",\"kind\":\"object\",\"type\":\"Sale\",\"relationName\":\"SaleToStockMovement\"},{\"name\":\"customerId\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"customer\",\"kind\":\"object\",\"type\":\"Customer\",\"relationName\":\"CustomerToStockMovement\"},{\"name\":\"reason\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"openingStock\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"physicalStock\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"closingStock\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"createdBy\",\"kind\":\"scalar\",\"type\":\"String\"}],\"dbName\":null}},\"enums\":{},\"types\":{}}");
defineDmmfProperty(exports.Prisma, config.runtimeDataModel);
config.compilerWasm = {
    getRuntime: async ()=>__turbopack_context__.r("[project]/Desktop/Inventory/my-app/src/generated/prisma/query_compiler_bg.js [app-ssr] (ecmascript)"),
    getQueryCompilerWasmModule: async ()=>{
        const { Buffer } = __turbopack_context__.r("[externals]/node:buffer [external] (node:buffer, cjs)");
        const { wasm } = __turbopack_context__.r("[project]/Desktop/Inventory/my-app/src/generated/prisma/query_compiler_bg.wasm-base64.js [app-ssr] (ecmascript)");
...
"[project]/Desktop/Inventory/my-app/src/generated/prisma/client.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

/* !!! This is code generated by Prisma. Do not edit directly. !!!
/* eslint-disable */ // biome-ignore-all lint: generated file
module.exports = {
    ...__turbopack_context__.r("[project]/Desktop/Inventory/my-app/src/generated/prisma/index.js [app-ssr] (ecmascript)")
};
}),
];

//# sourceMappingURL=Desktop_Inventory_my-app_src_generated_prisma_a887af1f._.js.map