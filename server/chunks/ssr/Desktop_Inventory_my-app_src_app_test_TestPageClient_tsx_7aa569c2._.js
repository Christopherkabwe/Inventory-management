...
(()=>{
    const e = new Error("Cannot find module '@/components/DateFiltersExports2'");
...
function TestPageClient({ inventory = [], locations = [], categories = [], products = [] }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Inventory$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(DateFiltersExports2, {
        locations: locations,
...
//# sourceMappingURL=Desktop_Inventory_my-app_src_app_test_TestPageClient_tsx_7aa569c2._.js.map