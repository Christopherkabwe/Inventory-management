...
async function GET(request) {
    ...
    try {
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productList.findMany({
            where: userId ? {
                createdBy: userId
            } : {},
            select: {
...
async function POST(request) {
    try {
        ...
        const existingProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productList.findUnique({
            where: {
                sku
            }
        });
        ...
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
        ...
        const productWithQuantity = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productList.findUnique({
            where: {
                id: product.id
            },
            select: {
...
//# sourceMappingURL=src_5f406e04._.js.map