...
"[project]/Desktop/Inventory/my-app/src/app/api/products/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Inventory$2f$my$2d$app$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productList.findMany({
            where: userId ? {
                createdBy: userId
            } : {},
            select: {
...
async function POST(request) {
    try {
        const { name, sku, price, packSize, weightValue, weightUnit, userId, location, quantity = 0 } = await request.json();
        // Basic validation
        ...
        const existingProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Inventory$2f$my$2d$app$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productList.findUnique({
            where: {
                sku
            }
        });
        ...
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Inventory$2f$my$2d$app$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
        ...
        const productWithQuantity = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Inventory$2f$my$2d$app$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productList.findUnique({
            where: {
                id: product.id
            },
            select: {
        ...
        const totalQuantity = productWithQuantity.inventories.reduce((sum, inv)=>sum + inv.quantity, 0);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Inventory$2f$my$2d$app$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...productWithQuantity,
...
//# sourceMappingURL=Desktop_Inventory_my-app_src_17f329e3._.js.map