...
"[project]/Desktop/Inventory/my-app/src/app/api/transfers/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    const { id } = params;
    try {
        const transfer = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Inventory$2f$my$2d$app$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].transfer.findUnique({
            where: {
                id
            },
            include: {
...
async function PUT(req, context) {
    ...
    const transfer = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Inventory$2f$my$2d$app$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].transfer.update({
        where: {
            id
        },
        data: {
...
async function DELETE(req, context) {
    ...
    if (!id) return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Inventory$2f$my$2d$app$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Missing transfer ID"
    }, {
        status: 400
    });
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Inventory$2f$my$2d$app$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].transfer.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=Desktop_Inventory_my-app_src_8847ed95._.js.map