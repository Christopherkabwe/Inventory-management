...
"[project]/src/app/api/transfers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        const transfers = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].transfer.findMany({
            orderBy: {
                createdAt: "desc"
            },
            take: limit,
...
async function POST(req) {
    try {
        ...
        const transfer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].transfer.create({
            data: {
                productId,
...
//# sourceMappingURL=src_7e0d0d04._.js.map