...
-- CreateIndex
CREATE UNIQUE INDEX "InventoryHistory_saleItemId_key" ON "InventoryHistory"("saleItemId");

-- CreateIndex
CREATE UNIQUE INDEX "InventoryHistory_transferReceiptItemId_key" ON "InventoryHistory"("transferReceiptItemId");

-- CreateIndex
CREATE UNIQUE INDEX "InventoryHistory_productionItemId_key" ON "InventoryHistory"("productionItemId");

-- CreateIndex
CREATE UNIQUE INDEX "InventoryHistory_adjustmentItemId_key" ON "InventoryHistory"("adjustmentItemId");

-- CreateIndex
CREATE UNIQUE INDEX "InventoryHistory_saleReturnId_key" ON "InventoryHistory"("saleReturnId");
...
-- AddForeignKey
ALTER TABLE "InventoryHistory" ADD CONSTRAINT "InventoryHistory_transferReceiptItemId_fkey" FOREIGN KEY ("transferReceiptItemId") REFERENCES "TransferReceiptItem"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InventoryHistory" ADD CONSTRAINT "InventoryHistory_productionItemId_fkey" FOREIGN KEY ("productionItemId") REFERENCES "ProductionItem"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InventoryHistory" ADD CONSTRAINT "InventoryHistory_adjustmentItemId_fkey" FOREIGN KEY ("adjustmentItemId") REFERENCES "AdjustmentItem"("id") ON DELETE SET NULL ON UPDATE CASCADE;
