...
export default function SalesOrderPage() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                // Fetch order
                const orderRes = await fetch(`/api/order-flow/orders/${id}`);
    ...
    const totals = order.items.reduce(
        ...
        { quantity: 0, tonnage: 0, productTotalValue: 0 }
    );
                            ...
                            <table className="w-full text-sm px-5">
                                <thead className="bg-zinc-100 border border-black">
                                    <tr className="border-b border-black">
                                        ...
                                        {/*<th className="px-4 py-2 border-r border-black text-center">Category</th>*/}
                                ...
                                <tbody className="border border-black">
                                    {order.items.map((item, idx) => (
                                        ...
                                        >
                                            ...
                                            {/*<td className="px-4 py-2 border-r border-black">{item.product.category ?? "-"}</td>*/}
                                    ...
                                    <EmptyRows columns={9} count={Math.max(0, 10 - order.items.length)} />
                                </tbody>
