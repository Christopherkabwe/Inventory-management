            ...
            <div className="px-2">
                ...
                <div id="print-area" className="print:border print:border-black bg-white">
                    <div className="space-y-1 py-4">
                        ...
                        {/* META */}
                        <div className="grid grid-cols-2 px-5 xl:grid-cols-4 mb-5 print-grid-cols-4">
                            <div>
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-3 gap-0 items-stretch px-5 print-grid-cols-3">
                            ...
                            <div className="border border-black px-5 py-2">
                                ...
                                <p className="text-sm py-1">Driver:______________</p>
                                <p className="text-sm py-1">Time:________________</p>
                                <p className="text-sm py-1">Signature:___________</p>
                            </div>
                        </div>
                    </div>
                </div>
