    ...
    return (
        ...
        <>
            <div className="min-h-screen">
                ...
                {/* KPIs */}
                <div className="grid grid-cols-1 xl:grid-cols-5 gap-6 mb-5 text-black">
                ...
                {/* MAIN GRID */}
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-5 text-black">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-1 gap-6 mb-5 text-black">
                    <InventorySummary
                ...
                {/* LOW STOCK BY LOCATION (COLUMNS) */}
                <div className="mb-5">
                    <div className="bg-white p-6 rounded-xl text-black border hover:shadow-md transition-shadow ">
