...
export default function SalesTrendChart({ salesTrendData, sales, productList }: Props) {
    ...
    const valueTrendData = useMemo(
        () => aggregateTrendData(salesTrendData, valueView),
        [salesTrendData, valueView]
    );

    const tonnageTrendData = useMemo(
        () => aggregateTrendData(salesTrendData, tonnageView),
        [salesTrendData, tonnageView]
    );
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl border">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <select
                            value={valueView}
                            onChange={e => setValueView(e.target.value as ViewMode)}
                ...
                <div className="bg-white p-6 rounded-xl border">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <select
                            value={tonnageView}
                            onChange={e => setTonnageView(e.target.value as ViewMode)}
                            className="text-xs border rounded-md px-2 py-1 bg-white"
                        >
                            <option value="daily">Daily</option>
                            <option value="monthly">Monthly</option>
