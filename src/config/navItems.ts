...
export const NAV_ITEMS: NavItem[] = [
    ...
    },
    {
        ...
        subItems: [
            ...
            { name: "Material Requirement Planning", href: "/production/mrp" },
            { name: "Capacity Planning", href: "/production/capacity-planning" },
        ],
    },
    {
        name: "Products",
...

    {
        ...
        icon: User,
        subItems: [
            { name: "Create supplier", href: "/suppliers/create" },
