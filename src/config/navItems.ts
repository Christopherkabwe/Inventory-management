...
export const NAV_ITEMS: NavItem[] = [
    ...
    },
    {
        ...
        subItems: [
            ...
            { name: "Work Order Management", href: "/production" },
            { name: "Quality Control", href: "/production" },
            { name: "Material Requirement Planning", href: "/production" },
            { name: "Capacity Planning", href: "/production" },
        ],
    },
    {
        name: "Products",
