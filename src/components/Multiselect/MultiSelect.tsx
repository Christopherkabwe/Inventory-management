            ...
            {open &&
                ...
                createPortal(
                    <div
                        ...
                        className="z-[9999] bg-white border rounded-md shadow-lg max-h-60 overflow-auto"
                    >
                        {searchable && (
                            <input
                                type="text"
...
export default function FiltersClient() {
  ...
  return (
    <div className="space-y-4">
        ...
        <LocationSelect locations={locations} value={selectedLocations} onChange={setSelectedLocations} />
